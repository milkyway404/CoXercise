...
enum class SkinImageButton {
    PAUSE_PLAY, QUIT, SOUND_ON_OFF, WARRIOR_ATTACK, ARCHER_ATTACK, PRIEST_ATTACK, WARRIOR_SPECIAL, PRIEST_SPECIAL, ARCHER_SPECIAL
}
...
enum class SkinImage(val atlasKey: String) {
    ...
    ARCHER_SPECIAL("archerSpecial"),
    PRIEST_ATTACK("priestAttack"),
    PRIEST_SPECIAL("priestSpecialAttack"),
    PLAY("play"),
    PAUSE("pause"),
    QUIT("quit"),
    FRAME("frame"),
...
private fun Skin.createImageButtonStyles(skin: Skin) {
    ...
    imageButton(SkinImageButton.ARCHER_SPECIAL.name) {
        imageUp = skin.getDrawable(SkinImage.ARCHER_SPECIAL.atlasKey)
        imageDown = imageUp
    }
    ...
    imageButton(SkinImageButton.PRIEST_SPECIAL.name) {
        imageUp = skin.getDrawable(SkinImage.PRIEST_SPECIAL.atlasKey)
        imageDown = imageUp
    }
    imageButton(SkinImageButton.WARRIOR_ATTACK.name) {
        imageUp = skin.getDrawable(SkinImage.WARRIOR_ATTACK.atlasKey)
