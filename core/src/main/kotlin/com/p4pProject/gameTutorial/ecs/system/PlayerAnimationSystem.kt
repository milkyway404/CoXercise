...
//        }
    ...
    private fun animateUp(aniCmp:PlayerAnimationComponent, deltaTime: Float): TextureRegion {
    ...
    private fun animateDown(aniCmp:PlayerAnimationComponent, deltaTime: Float): TextureRegion {
    ...
    private fun animateLeft(aniCmp:PlayerAnimationComponent, deltaTime: Float): TextureRegion {
    ...
    private fun animateRight(aniCmp:PlayerAnimationComponent, deltaTime: Float): TextureRegion {
